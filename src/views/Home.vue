        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde el inicio del desarrollo de software, la calidad ha sido un aspecto clave para garantizar soluciones confiables, seguras y eficientes. La prueba de software, en este sentido, se presenta como una práctica fundamental para asegurar que los productos cumplan con los requerimientos funcionales y no funcionales esperados. En esta tercera unidad, se abordarán los fundamentos de la calidad del software, sus atributos esenciales y los distintos tipos de pruebas que permiten verificar y validar los sistemas desarrollados. Además, se explorarán estrategias de planificación y documentación de pruebas, así como herramientas que apoyan su ejecución automatizada o manual.


              p.descripcion.mb-4 #[strong ¡Prepárese para fortalecer sus habilidades técnicas y contribuir al desarrollo de software de alta calidad!]
